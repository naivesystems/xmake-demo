...
int32_t engine_exhaust_gas_temperature_raw; //test
int32_t engine_exhaust_gas_temperature_scaled; //test
int32_t engine_exhaust_gas_temp_raw; //test
int32_t engine_exhaust_gas_temp_scaled; //test
